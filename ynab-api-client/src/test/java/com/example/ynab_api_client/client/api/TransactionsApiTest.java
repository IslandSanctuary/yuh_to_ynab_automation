...
public class TransactionsApiTest {
    ...
    public void createTransactionTest() throws ApiException {
        ...
        SaveTransactionsResponse response = 
        api.createTransaction(budgetId, data);
    ...
    public void deleteTransactionTest() throws ApiException {
        ...
        api.deleteTransaction(budgetId, transactionId);
    ...
    public void getTransactionByIdTest() throws ApiException {
        ...
        String transactionId = null;
        TransactionResponse response = 
        api.getTransactionById(budgetId, transactionId);
    ...
    public void getTransactionsTest() throws ApiException {
        ...
        api.getTransactions(budgetId, sinceDate, type, lastKnowledgeOfServer);
    ...
    public void getTransactionsByAccountTest() throws ApiException {
        ...
        Long lastKnowledgeOfServer = null;
        TransactionsResponse response = 
        api.getTransactionsByAccount(budgetId, accountId, sinceDate, type, lastKnowledgeOfServer);
    ...
    public void getTransactionsByCategoryTest() throws ApiException {
        ...
        String type = null;
        Long lastKnowledgeOfServer = null;
        HybridTransactionsResponse response = 
        api.getTransactionsByCategory(budgetId, categoryId, sinceDate, type, lastKnowledgeOfServer);
     ...
     */
    @Test
    public void getTransactionsByMonthTest() throws ApiException {
        String budgetId = null;
        String month = null;
        LocalDate sinceDate = null;
        String type = null;
        Long lastKnowledgeOfServer = null;
        HybridTransactionsResponse response = 
        api.getTransactionsByMonth(budgetId, month, sinceDate, type, lastKnowledgeOfServer);
    ...
    public void getTransactionsByPayeeTest() throws ApiException {
        ...
        Long lastKnowledgeOfServer = null;
        HybridTransactionsResponse response = 
        api.getTransactionsByPayee(budgetId, payeeId, sinceDate, type, lastKnowledgeOfServer);
    ...
    public void importTransactionsTest() throws ApiException {
        String budgetId = null;
        TransactionsImportResponse response = 
        api.importTransactions(budgetId);
    ...
    public void updateTransactionTest() throws ApiException {
        ...
        TransactionResponse response = 
        api.updateTransaction(budgetId, transactionId, data);
    ...
    public void updateTransactionsTest() throws ApiException {
        ...
        SaveTransactionsResponse response = 
        api.updateTransactions(budgetId, data);
