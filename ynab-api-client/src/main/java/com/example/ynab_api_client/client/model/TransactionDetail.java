 ...
 */
@JsonPropertyOrder({
  TransactionDetail.JSON_PROPERTY_ID,
  TransactionDetail.JSON_PROPERTY_DATE,
  TransactionDetail.JSON_PROPERTY_AMOUNT,
  TransactionDetail.JSON_PROPERTY_MEMO,
  TransactionDetail.JSON_PROPERTY_CLEARED,
  TransactionDetail.JSON_PROPERTY_APPROVED,
  TransactionDetail.JSON_PROPERTY_FLAG_COLOR,
  TransactionDetail.JSON_PROPERTY_FLAG_NAME,
  TransactionDetail.JSON_PROPERTY_ACCOUNT_ID,
  TransactionDetail.JSON_PROPERTY_PAYEE_ID,
  TransactionDetail.JSON_PROPERTY_CATEGORY_ID,
  TransactionDetail.JSON_PROPERTY_TRANSFER_ACCOUNT_ID,
  TransactionDetail.JSON_PROPERTY_TRANSFER_TRANSACTION_ID,
  TransactionDetail.JSON_PROPERTY_MATCHED_TRANSACTION_ID,
  TransactionDetail.JSON_PROPERTY_IMPORT_ID,
  TransactionDetail.JSON_PROPERTY_IMPORT_PAYEE_NAME,
  TransactionDetail.JSON_PROPERTY_IMPORT_PAYEE_NAME_ORIGINAL,
  TransactionDetail.JSON_PROPERTY_DEBT_TRANSACTION_TYPE,
  TransactionDetail.JSON_PROPERTY_DELETED,
  TransactionDetail.JSON_PROPERTY_ACCOUNT_NAME,
  TransactionDetail.JSON_PROPERTY_PAYEE_NAME,
  TransactionDetail.JSON_PROPERTY_CATEGORY_NAME,
  TransactionDetail.JSON_PROPERTY_SUBTRANSACTIONS
})
...
public class TransactionDetail {
  ...
  public TransactionDetail id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public TransactionDetail date(@jakarta.annotation.Nonnull LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  public TransactionDetail amount(@jakarta.annotation.Nonnull Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  public TransactionDetail memo(@jakarta.annotation.Nullable String memo) {
  ...
  public TransactionDetail cleared(@jakarta.annotation.Nonnull TransactionClearedStatus cleared) {
  ...
  public TransactionDetail approved(@jakarta.annotation.Nonnull Boolean approved) {
  ...
  public TransactionDetail flagColor(@jakarta.annotation.Nullable TransactionFlagColor flagColor) {
  ...
  public TransactionDetail flagName(@jakarta.annotation.Nullable String flagName) {
  ...
  public TransactionDetail accountId(@jakarta.annotation.Nonnull UUID accountId) {
  ...
  public TransactionDetail payeeId(@jakarta.annotation.Nullable UUID payeeId) {
  ...
  public TransactionDetail categoryId(@jakarta.annotation.Nullable UUID categoryId) {
  ...
  public TransactionDetail transferAccountId(@jakarta.annotation.Nullable UUID transferAccountId) {
  ...
  public TransactionDetail transferTransactionId(@jakarta.annotation.Nullable String transferTransactionId) {
  ...
  public TransactionDetail matchedTransactionId(@jakarta.annotation.Nullable String matchedTransactionId) {
  ...
  public TransactionDetail importId(@jakarta.annotation.Nullable String importId) {
  ...
  public TransactionDetail importPayeeName(@jakarta.annotation.Nullable String importPayeeName) {
  ...
  public TransactionDetail importPayeeNameOriginal(@jakarta.annotation.Nullable String importPayeeNameOriginal) {
  ...
  public TransactionDetail debtTransactionType(@jakarta.annotation.Nullable DebtTransactionTypeEnum debtTransactionType) {
  ...
  public TransactionDetail deleted(@jakarta.annotation.Nonnull Boolean deleted) {
  ...
  public TransactionDetail accountName(@jakarta.annotation.Nonnull String accountName) {
  ...
  public TransactionDetail payeeName(@jakarta.annotation.Nullable String payeeName) {
  ...
  public TransactionDetail categoryName(@jakarta.annotation.Nullable String categoryName) {
  ...
  public TransactionDetail subtransactions(@jakarta.annotation.Nonnull List<SubTransaction> subtransactions) {
  ...
  @JsonProperty(JSON_PROPERTY_SUBTRANSACTIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSubtransactions(@jakarta.annotation.Nonnull List<SubTransaction> subtransactions) {
    this.subtransactions = subtransactions;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, transactionDetail.id) &&
        ...
        equalsNullable(this.memo, transactionDetail.memo) &&
        Objects.equals(this.cleared, transactionDetail.cleared) &&
        Objects.equals(this.approved, transactionDetail.approved) &&
        equalsNullable(this.flagColor, transactionDetail.flagColor) &&
        equalsNullable(this.flagName, transactionDetail.flagName) &&
        Objects.equals(this.accountId, transactionDetail.accountId) &&
        equalsNullable(this.payeeId, transactionDetail.payeeId) &&
        equalsNullable(this.categoryId, transactionDetail.categoryId) &&
        equalsNullable(this.transferAccountId, transactionDetail.transferAccountId) &&
        equalsNullable(this.transferTransactionId, transactionDetail.transferTransactionId) &&
        equalsNullable(this.matchedTransactionId, transactionDetail.matchedTransactionId) &&
        equalsNullable(this.importId, transactionDetail.importId) &&
        equalsNullable(this.importPayeeName, transactionDetail.importPayeeName) &&
        equalsNullable(this.importPayeeNameOriginal, transactionDetail.importPayeeNameOriginal) &&
        equalsNullable(this.debtTransactionType, transactionDetail.debtTransactionType) &&
        Objects.equals(this.deleted, transactionDetail.deleted) &&
        Objects.equals(this.accountName, transactionDetail.accountName) &&
        equalsNullable(this.payeeName, transactionDetail.payeeName) &&
        equalsNullable(this.categoryName, transactionDetail.categoryName) &&
