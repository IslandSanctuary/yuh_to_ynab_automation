 ...
 */
@JsonPropertyOrder({
  PayeesResponseData.JSON_PROPERTY_PAYEES,
  PayeesResponseData.JSON_PROPERTY_SERVER_KNOWLEDGE
})
...
public class PayeesResponseData {
  ...
  public PayeesResponseData payees(@jakarta.annotation.Nonnull List<Payee> payees) {
    this.payees = payees;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYEES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPayees(@jakarta.annotation.Nonnull List<Payee> payees) {
    this.payees = payees;
  }


  public PayeesResponseData serverKnowledge(@jakarta.annotation.Nonnull Long serverKnowledge) {
  ...
  /**
   * Return true if this PayeesResponse_data object is equal to o.
   */
  @Override
