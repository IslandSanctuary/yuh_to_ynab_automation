...
import com.example.ynab_api_client.client.model.BudgetSettings;
 ...
 */
@JsonPropertyOrder({
  BudgetSettingsResponseData.JSON_PROPERTY_SETTINGS
})
...
public class BudgetSettingsResponseData {
  ...
  public BudgetSettingsResponseData settings(@jakarta.annotation.Nonnull BudgetSettings settings) {
  ...
  @JsonProperty(JSON_PROPERTY_SETTINGS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSettings(@jakarta.annotation.Nonnull BudgetSettings settings) {
    this.settings = settings;
  }


  /**
   * Return true if this BudgetSettingsResponse_data object is equal to o.
   */
  @Override
