...
import com.example.ynab_api_client.client.model.BudgetSummaryResponseData;
 ...
 */
@JsonPropertyOrder({
  BudgetSummaryResponse.JSON_PROPERTY_DATA
})
...
public class BudgetSummaryResponse {
  ...
  public BudgetSummaryResponse data(@jakarta.annotation.Nonnull BudgetSummaryResponseData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull BudgetSummaryResponseData data) {
    this.data = data;
  }


  /**
   * Return true if this BudgetSummaryResponse object is equal to o.
   */
  @Override
