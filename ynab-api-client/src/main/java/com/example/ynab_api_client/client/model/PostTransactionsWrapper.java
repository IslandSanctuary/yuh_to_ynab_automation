...
import com.example.ynab_api_client.client.model.NewTransaction;
 ...
 */
@JsonPropertyOrder({
  PostTransactionsWrapper.JSON_PROPERTY_TRANSACTION,
  PostTransactionsWrapper.JSON_PROPERTY_TRANSACTIONS
})
...
public class PostTransactionsWrapper {
  ...
  public PostTransactionsWrapper transaction(@jakarta.annotation.Nullable NewTransaction transaction) {
  ...
  @JsonProperty(JSON_PROPERTY_TRANSACTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTransaction(@jakarta.annotation.Nullable NewTransaction transaction) {
    this.transaction = transaction;
  }


  public PostTransactionsWrapper transactions(@jakarta.annotation.Nullable List<NewTransaction> transactions) {
  ...
  @JsonProperty(JSON_PROPERTY_TRANSACTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTransactions(@jakarta.annotation.Nullable List<NewTransaction> transactions) {
    this.transactions = transactions;
  }


  /**
   * Return true if this PostTransactionsWrapper object is equal to o.
   */
  @Override
