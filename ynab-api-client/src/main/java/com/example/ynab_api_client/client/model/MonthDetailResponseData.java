 ...
 */
@JsonPropertyOrder({
  MonthDetailResponseData.JSON_PROPERTY_MONTH
})
...
public class MonthDetailResponseData {
  ...
  public MonthDetailResponseData month(@jakarta.annotation.Nonnull MonthDetail month) {
    this.month = month;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MONTH)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setMonth(@jakarta.annotation.Nonnull MonthDetail month) {
    this.month = month;
  }


  /**
   * Return true if this MonthDetailResponse_data object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMonth() != null) {
      joiner.add(getMonth().toUrlQueryString(prefix + "month" + suffix));
    }
