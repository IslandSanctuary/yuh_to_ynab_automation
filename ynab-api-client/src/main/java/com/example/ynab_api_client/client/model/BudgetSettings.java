 ...
 */
@JsonPropertyOrder({
  BudgetSettings.JSON_PROPERTY_DATE_FORMAT,
  BudgetSettings.JSON_PROPERTY_CURRENCY_FORMAT
})
...
public class BudgetSettings {
  ...
  public BudgetSettings dateFormat(@jakarta.annotation.Nullable DateFormat dateFormat) {
  ...
  public BudgetSettings currencyFormat(@jakarta.annotation.Nullable CurrencyFormat currencyFormat) {
  ...
  /**
   * Return true if this BudgetSettings object is equal to o.
   */
  @Override
