...
import com.example.ynab_api_client.client.model.CategoriesResponseData;
 ...
 */
@JsonPropertyOrder({
  CategoriesResponse.JSON_PROPERTY_DATA
})
...
public class CategoriesResponse {
  ...
  public CategoriesResponse data(@jakarta.annotation.Nonnull CategoriesResponseData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull CategoriesResponseData data) {
    this.data = data;
  }


  /**
   * Return true if this CategoriesResponse object is equal to o.
   */
  @Override
