 ...
 */
@JsonPropertyOrder({
  BulkTransactions.JSON_PROPERTY_TRANSACTIONS
})
...
public class BulkTransactions {
  ...
  private List<SaveTransactionWithOptionalFields> transactions = new ArrayList<>();

  public BulkTransactions() { 
  }

  public BulkTransactions transactions(@jakarta.annotation.Nonnull List<SaveTransactionWithOptionalFields> transactions) {
    this.transactions = transactions;
    return this;
  }

  public BulkTransactions addTransactionsItem(SaveTransactionWithOptionalFields transactionsItem) {
  ...
  public List<SaveTransactionWithOptionalFields> getTransactions() {
    return transactions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TRANSACTIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTransactions(@jakarta.annotation.Nonnull List<SaveTransactionWithOptionalFields> transactions) {
    this.transactions = transactions;
  }


  /**
   * Return true if this BulkTransactions object is equal to o.
   */
  @Override
