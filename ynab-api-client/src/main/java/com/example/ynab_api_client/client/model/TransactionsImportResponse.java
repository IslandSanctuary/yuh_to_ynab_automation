...
import com.example.ynab_api_client.client.model.TransactionsImportResponseData;
 ...
 */
@JsonPropertyOrder({
  TransactionsImportResponse.JSON_PROPERTY_DATA
})
...
public class TransactionsImportResponse {
  ...
  public TransactionsImportResponse data(@jakarta.annotation.Nonnull TransactionsImportResponseData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull TransactionsImportResponseData data) {
    this.data = data;
  }


  /**
   * Return true if this TransactionsImportResponse object is equal to o.
   */
  @Override
