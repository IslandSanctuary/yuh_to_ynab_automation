 ...
 */
@JsonPropertyOrder({
  TransactionResponseData.JSON_PROPERTY_TRANSACTION,
  TransactionResponseData.JSON_PROPERTY_SERVER_KNOWLEDGE
})
...
public class TransactionResponseData {
  ...
  public TransactionResponseData transaction(@jakarta.annotation.Nonnull TransactionDetail transaction) {
  ...
  @JsonProperty(JSON_PROPERTY_TRANSACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTransaction(@jakarta.annotation.Nonnull TransactionDetail transaction) {
    this.transaction = transaction;
  }


  public TransactionResponseData serverKnowledge(@jakarta.annotation.Nonnull Long serverKnowledge) {
  ...
  /**
   * Return true if this TransactionResponse_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transaction, transactionResponseData.transaction) &&
        Objects.equals(this.serverKnowledge, transactionResponseData.serverKnowledge);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transaction, serverKnowledge);
  }
