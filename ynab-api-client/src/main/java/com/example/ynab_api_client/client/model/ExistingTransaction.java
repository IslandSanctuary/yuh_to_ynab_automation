 ...
 */
@JsonPropertyOrder({
  ExistingTransaction.JSON_PROPERTY_ACCOUNT_ID,
  ExistingTransaction.JSON_PROPERTY_DATE,
  ExistingTransaction.JSON_PROPERTY_AMOUNT,
  ExistingTransaction.JSON_PROPERTY_PAYEE_ID,
  ExistingTransaction.JSON_PROPERTY_PAYEE_NAME,
  ExistingTransaction.JSON_PROPERTY_CATEGORY_ID,
  ExistingTransaction.JSON_PROPERTY_MEMO,
  ExistingTransaction.JSON_PROPERTY_CLEARED,
  ExistingTransaction.JSON_PROPERTY_APPROVED,
  ExistingTransaction.JSON_PROPERTY_FLAG_COLOR,
  ExistingTransaction.JSON_PROPERTY_SUBTRANSACTIONS
})
...
public class ExistingTransaction {
  ...
  public ExistingTransaction accountId(@jakarta.annotation.Nullable UUID accountId) {
  ...
  public ExistingTransaction date(@jakarta.annotation.Nullable LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  public ExistingTransaction amount(@jakarta.annotation.Nullable Long amount) {
    this.amount = amount;
    return this;
  }
  ...
  public ExistingTransaction payeeId(@jakarta.annotation.Nullable UUID payeeId) {
  ...
  public ExistingTransaction payeeName(@jakarta.annotation.Nullable String payeeName) {
  ...
  public ExistingTransaction categoryId(@jakarta.annotation.Nullable UUID categoryId) {
  ...
  public ExistingTransaction memo(@jakarta.annotation.Nullable String memo) {
  ...
  public ExistingTransaction cleared(@jakarta.annotation.Nullable TransactionClearedStatus cleared) {
  ...
  public ExistingTransaction approved(@jakarta.annotation.Nullable Boolean approved) {
  ...
  public ExistingTransaction flagColor(@jakarta.annotation.Nullable TransactionFlagColor flagColor) {
  ...
  public ExistingTransaction subtransactions(@jakarta.annotation.Nullable List<SaveSubTransaction> subtransactions) {
  ...
  /**
   * Return true if this ExistingTransaction object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, existingTransaction.accountId) &&
        ...
        equalsNullable(this.payeeId, existingTransaction.payeeId) &&
        equalsNullable(this.payeeName, existingTransaction.payeeName) &&
        equalsNullable(this.categoryId, existingTransaction.categoryId) &&
        equalsNullable(this.memo, existingTransaction.memo) &&
        Objects.equals(this.cleared, existingTransaction.cleared) &&
        Objects.equals(this.approved, existingTransaction.approved) &&
        equalsNullable(this.flagColor, existingTransaction.flagColor) &&
