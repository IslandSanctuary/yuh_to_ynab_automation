...
import com.example.ynab_api_client.client.model.AccountsResponseData;
 ...
 */
@JsonPropertyOrder({
  AccountsResponse.JSON_PROPERTY_DATA
})
...
public class AccountsResponse {
  ...
  public AccountsResponse data(@jakarta.annotation.Nonnull AccountsResponseData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull AccountsResponseData data) {
    this.data = data;
  }


  /**
   * Return true if this AccountsResponse object is equal to o.
   */
  @Override
