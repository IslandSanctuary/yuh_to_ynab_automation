...
import com.example.ynab_api_client.client.model.PayeesResponseData;
 ...
 */
@JsonPropertyOrder({
  PayeesResponse.JSON_PROPERTY_DATA
})
...
public class PayeesResponse {
  ...
  public PayeesResponse data(@jakarta.annotation.Nonnull PayeesResponseData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull PayeesResponseData data) {
    this.data = data;
  }


  /**
   * Return true if this PayeesResponse object is equal to o.
   */
  @Override
