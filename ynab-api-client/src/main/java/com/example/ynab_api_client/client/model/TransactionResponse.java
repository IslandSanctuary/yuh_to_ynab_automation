 ...
 */
@JsonPropertyOrder({
  TransactionResponse.JSON_PROPERTY_DATA
})
...
public class TransactionResponse {
  ...
  public TransactionResponse data(@jakarta.annotation.Nonnull TransactionResponseData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull TransactionResponseData data) {
    this.data = data;
  }
