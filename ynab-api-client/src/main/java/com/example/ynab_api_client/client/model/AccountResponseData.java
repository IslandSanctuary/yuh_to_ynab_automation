 ...
 */
@JsonPropertyOrder({
  AccountResponseData.JSON_PROPERTY_ACCOUNT
})
...
public class AccountResponseData {
  ...
  public AccountResponseData account(@jakarta.annotation.Nonnull Account account) {
  ...
  @JsonProperty(JSON_PROPERTY_ACCOUNT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAccount(@jakarta.annotation.Nonnull Account account) {
    this.account = account;
  }


  /**
   * Return true if this AccountResponse_data object is equal to o.
   */
  @Override
