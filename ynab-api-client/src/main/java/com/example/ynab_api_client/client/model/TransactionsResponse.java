...
import com.example.ynab_api_client.client.model.TransactionsResponseData;
 ...
 */
@JsonPropertyOrder({
  TransactionsResponse.JSON_PROPERTY_DATA
})
...
public class TransactionsResponse {
  ...
  public TransactionsResponse data(@jakarta.annotation.Nonnull TransactionsResponseData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull TransactionsResponseData data) {
    this.data = data;
  }
