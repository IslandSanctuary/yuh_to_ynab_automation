 ...
 */
@JsonPropertyOrder({
  MonthSummary.JSON_PROPERTY_MONTH,
  MonthSummary.JSON_PROPERTY_NOTE,
  MonthSummary.JSON_PROPERTY_INCOME,
  MonthSummary.JSON_PROPERTY_BUDGETED,
  MonthSummary.JSON_PROPERTY_ACTIVITY,
  MonthSummary.JSON_PROPERTY_TO_BE_BUDGETED,
  MonthSummary.JSON_PROPERTY_AGE_OF_MONEY,
  MonthSummary.JSON_PROPERTY_DELETED
})
...
public class MonthSummary {
  ...
  public MonthSummary month(@jakarta.annotation.Nonnull LocalDate month) {
    this.month = month;
    return this;
  }
  ...
  public MonthSummary note(@jakarta.annotation.Nullable String note) {
  ...
  public MonthSummary income(@jakarta.annotation.Nonnull Long income) {
    this.income = income;
    return this;
  }
  ...
  public MonthSummary budgeted(@jakarta.annotation.Nonnull Long budgeted) {
  ...
  public MonthSummary activity(@jakarta.annotation.Nonnull Long activity) {
  ...
  public MonthSummary toBeBudgeted(@jakarta.annotation.Nonnull Long toBeBudgeted) {
  ...
  public MonthSummary ageOfMoney(@jakarta.annotation.Nullable Integer ageOfMoney) {
  ...
  public MonthSummary deleted(@jakarta.annotation.Nonnull Boolean deleted) {
  ...
  /**
   * Return true if this MonthSummary object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.month, monthSummary.month) &&
        equalsNullable(this.note, monthSummary.note) &&
        ...
        equalsNullable(this.ageOfMoney, monthSummary.ageOfMoney) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(month, hashCodeNullable(note), income, budgeted, activity, toBeBudgeted, hashCodeNullable(ageOfMoney), deleted);
  }
