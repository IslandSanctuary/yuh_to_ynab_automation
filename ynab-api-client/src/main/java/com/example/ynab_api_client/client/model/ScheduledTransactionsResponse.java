...
import com.example.ynab_api_client.client.model.ScheduledTransactionsResponseData;
 ...
 */
@JsonPropertyOrder({
  ScheduledTransactionsResponse.JSON_PROPERTY_DATA
})
...
public class ScheduledTransactionsResponse {
  ...
  public ScheduledTransactionsResponse data(@jakarta.annotation.Nonnull ScheduledTransactionsResponseData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull ScheduledTransactionsResponseData data) {
    this.data = data;
  }


  /**
   * Return true if this ScheduledTransactionsResponse object is equal to o.
   */
  @Override
