...
import com.example.ynab_api_client.client.model.AccountResponseData;
 ...
 */
@JsonPropertyOrder({
  AccountResponse.JSON_PROPERTY_DATA
})
...
public class AccountResponse {
  ...
  public AccountResponse data(@jakarta.annotation.Nonnull AccountResponseData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull AccountResponseData data) {
    this.data = data;
  }
