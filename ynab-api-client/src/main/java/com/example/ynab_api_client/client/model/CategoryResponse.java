...
import com.example.ynab_api_client.client.model.CategoryResponseData;
...
public class CategoryResponse {
  ...
  public CategoryResponse data(@jakarta.annotation.Nonnull CategoryResponseData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull CategoryResponseData data) {
    this.data = data;
  }
