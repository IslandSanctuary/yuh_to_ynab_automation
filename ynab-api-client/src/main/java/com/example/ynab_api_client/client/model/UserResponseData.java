...
import com.example.ynab_api_client.client.model.User;
 ...
 */
@JsonPropertyOrder({
  UserResponseData.JSON_PROPERTY_USER
})
...
public class UserResponseData {
  ...
  public UserResponseData user(@jakarta.annotation.Nonnull User user) {
    this.user = user;
    return this;
  }
  ...
  /**
   * Return true if this UserResponse_data object is equal to o.
   */
  @Override
