...
import com.example.ynab_api_client.client.model.ErrorDetail;
...
public class ErrorResponse {
  ...
  public ErrorResponse error(@jakarta.annotation.Nonnull ErrorDetail error) {
    this.error = error;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ERROR)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setError(@jakarta.annotation.Nonnull ErrorDetail error) {
    this.error = error;
  }
