...
import com.example.ynab_api_client.client.model.ScheduledTransactionResponseData;
 ...
 */
@JsonPropertyOrder({
  ScheduledTransactionResponse.JSON_PROPERTY_DATA
})
...
public class ScheduledTransactionResponse {
  ...
  public ScheduledTransactionResponse data(@jakarta.annotation.Nonnull ScheduledTransactionResponseData data) {
    this.data = data;
    return this;
  }
  ...
  public ScheduledTransactionResponseData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull ScheduledTransactionResponseData data) {
    this.data = data;
  }


  /**
   * Return true if this ScheduledTransactionResponse object is equal to o.
   */
  @Override
