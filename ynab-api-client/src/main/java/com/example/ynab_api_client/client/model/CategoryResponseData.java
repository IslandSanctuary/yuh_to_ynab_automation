 ...
 */
@JsonPropertyOrder({
  CategoryResponseData.JSON_PROPERTY_CATEGORY
})
...
public class CategoryResponseData {
  ...
  public CategoryResponseData category(@jakarta.annotation.Nonnull Category category) {
  ...
  /**
   * Return true if this CategoryResponse_data object is equal to o.
   */
  @Override
