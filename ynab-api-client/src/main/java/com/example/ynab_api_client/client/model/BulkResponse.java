...
import com.example.ynab_api_client.client.model.BulkResponseData;
 ...
 */
@JsonPropertyOrder({
  BulkResponse.JSON_PROPERTY_DATA
})
...
public class BulkResponse {
  ...
  private BulkResponseData data;

  public BulkResponse() { 
  }

  public BulkResponse data(@jakarta.annotation.Nonnull BulkResponseData data) {
    this.data = data;
    return this;
  }
  ...
  public BulkResponseData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@jakarta.annotation.Nonnull BulkResponseData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, bulkResponse.data);
  }
